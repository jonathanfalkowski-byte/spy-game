(function () {
  ...
  Object.assign(window.STORY, {
    c20_start: {
      ...
      pages: [
        "The weather grid over Plate Seven has been set to funeral weather since noon, a civic courtesy for a senator's closed-door hearing that never happened. Rain arrives in ruled lines, each drop the same size, each interval the same lie. Helix Dynamics stands at the far edge of the plate like a white tooth in a black mouth. The wellness logos have been dimmed for 'maintenance.' The maintenance is you.\n\nYou have a window of forty-one minutes before the night shift rotates and the biometric doors remember they are doors. In your coat: a badge that has already died twice, a pistol that has been fired in a stairwell you will not put in a report, and a blank drive the size of a fingernail. Kane called it a harvest tool. Voss called it a confession. Crowe did not call it anything. She sent a calendar invite titled ORCHARD and a photograph of your own face from a camera you never agreed to.",
        "Below the deck, the Stack performs its usual midnight arithmetic. Trams move workers toward sleep. Clinics drain their last appointments into paper cups. Someone on a lower plate is burning incense that is illegal only if you sell it without a license. You check the exits because that is the last civilian habit you have not sold. There are three. One of them is a lie with a camera in its throat.\n\n{{name}}. The name still fits in your mouth if you do not bite down. After tonight it will belong to whoever holds the codes — Voss with her wet coat and her remaining ethics, Crowe with her office that smells of citrus and other people's futures, or you, which is the most dangerous of the three because you have already proven you can want two things that cannot share a room. The rain writes the same sentence on your sleeves until the fabric gives up and believes it.",
      ],
      next: "c20_tram",
    },
    ...
    c20_service: {
      ...
      pages: [
        ...
        "You surface in a laundry annex that believes it is unimportant. Importance is a lighting design. This room has none. You straighten, check the pistol, check the drive, check the name you are still using. {{name}} still answers. That will do for the next forty minutes.\n\nA service lift stands open as if it has been waiting to be a metaphor. You take the stairs instead. Lifts remember weight. Stairs only remember pain, and pain is common enough to be invisible. Your earpiece ticks. Voss: \"Ugly entrance. Good. Ugly is harder to subpoena.\"",
      ],
      next: "c20_atrium",
    },
    ...
    c20_atrium: {
      ...
      speaker: "",
      pages: [
        "However you arrived, the atrium makes you the same person: a silhouette against branded amber, a possible patient, a possible thief. The fountain talks to itself. A night playlist offers piano that has been tested on focus groups for its ability to lower heart rate without lowering spending. You cross the marble as if you have a right to be late.\n\nOn the mezzanine, a figure in a dark coat watches the sculpture. Not Crowe. Too still for Maren. You do not change your pace. Changing pace is how watchers learn they have been seen. The figure turns out to be a coat on a stand, left by someone who believed they would return. Helix is full of objects practicing being people. You have been one of them. You may still be.",
    ...
    c20_clinic: {
      ...
      speaker: "",
      pages: [
        "Vale's night clinic is still awake. Of course it is. Conversion does not punch a clock; it only punches tickets. The glass is half-frosted in the corporate way that means privacy for the firm and exposure for the patient. You see a silhouette on a table, not moving enough to be asleep, moving too much to be gone. Nurse Lila crosses the glass with a tray. She sees you. She does not drop the tray. That is her professionalism and her tragedy.\n\nShe comes to the hall door and opens it the width of a conscience. The clinic smell reaches you: alcohol, warm plastic, the sweet chemical that means someone's endocrine panel is being rewritten in real time. You have smelled it on your own sheets. You may smell it on them again if tonight goes the way Crowe prefers.",
        "\"You shouldn't be on C,\" Lila says. Her voice is the kind of kind that still bills by the procedure. \"Vale is in the orchard. He said if you came, I should tell you the switch is not a metaphor, and that metaphors are how patients forgive us.\" She looks at your hands the way Radek did, then at your mouth, then at the place on your throat where a CHRYSALIS port would sit if you had agreed to all of it.\n\nBehind her, the silhouette on the table makes a sound that might be a name. It is not yours. You are grateful and ashamed of the gratitude. Lila waits. She has always been better at waiting than the doctors. Waiting is how she stays a person.",
      ],
      choices: [
        {
          text: "Ask her for the clean way in. Trust the kindness that is still a procedure.",
          to: "c20_lila_kind",
          effects: { integrity: 6, heat: -2 },
        },
        {
          text: "Tell her to go back to the table. You didn't come for mercy.",
          to: "c20_lila_hard",
    ...
    c20_lila_kind: {
      ...
      speaker: "Lila",
      pages: [
        "Lila's mouth tightens, which is how she smiles when smiling would be a violation. \"Service lock on the orchard is coded to Vale's left hand and to a night nurse override I am not supposed to have. I have it because someone has to turn the lights off when the doctors forget patients are not equipment.\" She presses a fob into your palm. It is warm. She has been holding it since she saw you in the glass, which means she decided before you arrived.\n\n\"If you shut it down,\" she says, very low, \"the people on the tables don't vanish. They just stop being improved. Some of them will hate you for that. Some of them will send you money from countries with trees. I don't know which kind I am. I don't know which kind you are.\" Her eyes are tired in a human way the firm has not yet productized.",
        "You close your hand around the fob. It feels like a small animal that has already chosen you. \"Vale will talk,\" she adds. \"He always talks when the fruit is ripe. Don't let him make it sound like philosophy. It's inventory.\"\n\nShe goes back to the silhouette. You hear her voice change into the voice she uses for people whose names are being rewritten: soft, specific, refusing to be a recording. You leave her that. It is the only unstolen thing in the hallway. The orchard door is ten meters away and glowing as if it were glad.",
      ],
      next: "c20_vale",
    },
    ...
    c20_packet: {
      ...
      pages: [
        ...
        "Now the only question left is the oldest one in this city: who you hand the prayer to. The fans have not changed. The cold has not changed. You have. You can feel the change as a heat that does not belong in this room, a human weather gathering under your coat.\n\nFootsteps on the grate. Not Vale. Vale does not hurry and does not wear heels that announce policy. Maren Pell comes through the rows like a rumor that got funded. She has a sidearm and a smile and the particular glow of someone who has been waiting to be the scene.",
      ],
      next: "c20_maren",
    },
    ...
    c20_maren: {
      ...
      speaker: "Maren",
      pages: [
        "Maren stops at a polite distance that is also a shooting distance. Her coat is open. Under it, the black of Helix night staff, tailored to remind you she has a body and that the body is part of her report. Crowe's lieutenant. Younger. Hungrier. She looks at the empty cradle, then at your hand, then at your mouth, as if the codes might be in your teeth.\n\n\"Director Crowe asked me to offer you a ride,\" she says. \"She also asked me to offer you a reason to be late. I am authorized to be either a door or a bed. You can tell me which one photographs better.\" The fans make a chapel of the offer. Her perfume is the same citrus as the atrium, worn warmer, worn like a joke about cleanliness.",
        "You could shoot her. The orchard would record it as a thermal event. You could give her the drive and become a line in her loyalty column. You could let her put her mouth on you against a server rack named BOSC and buy four minutes of confusion in the cameras, which is sometimes the same thing as living.\n\nShe tilts her head. \"Don't look pious. You came into our fruit. Fruit stains. I'm just offering you a say in the color.\" Her eyes are bright with the specific arousal of people who were promoted for wanting. It is not fake. That is what makes it usable. That is what makes it dangerous.",
      ],
      choices: [
        {
          text: "Take the minutes. Use her mouth, her hunger, the cameras' confusion.",
          to: "c20_maren_yes",
          effects: { corruption: 10, heat: 8, flags: { honey: true } },
        },
        {
          text: "Keep the distance. She is a report with a pulse.",
          to: "c20_maren_no",
    ...
    c20_maren_yes: {
      ...
      speaker: "",
      pages: [
        "You do not kiss her first. Kissing would imply a civilian grammar. You take her by the belt and put her back against BOSC, the rack humming through her spine into your wrist. She makes a sound that is half laugh, half filing note. Her mouth finds yours as if she has practiced on a briefing photo. She tastes of mint and the metallic chill of the room and a sweetness she put there on purpose.\n\nHer hand goes into your coat and does not reach for the drive. She is better than that. She reaches for skin, for the heat you brought in from the stairwell, for the proof that you can still be lowered into a body. You let her. Letting is a tactic and a want and you are no longer in a job that separates those cleanly. The grate bites the soles of your shoes. Her thigh slots between yours with professional accuracy. The fans cover the wetter sounds. That is why she chose this row.",
        "She gets on her knees because she wants the report to include the image and because she wants the image. Cold air finds the back of your neck while her mouth finds the rest of you, unhurried, thorough, a person conducting an audit with her tongue. You hold the rack, not her hair; holding her hair would be a promise. She looks up once, eyes bright, chin wet, and the look says: you can still be owned in pieces even if you leave with the whole packet.\n\nYou come with your teeth closed and your hand locked on metal that does not care. She swallows as if swallowing were policy, stands, wipes her mouth with the back of her wrist, and is immediately a lieutenant again. \"Four minutes,\" she says, voice roughened into honesty. \"Crowe will know anyway. I wanted you to remember that I got there first.\" She does not take the drive. She wants you to carry it to her director like a dog that has learned a trick. You step away from BOSC. The rack keeps humming. You keep the taste of mint and copper and a decision you will not put in the journal.",
      ],
      next: "c20_comms",
    },
    ...
    c20_maren_no: {
      ...
      speaker: "Maren",
      pages: [
        "\"No,\" you say, and the word comes out cleaner than you feel. Maren's smile does not fall; it changes tax status. She holsters the offer the way she holsters the sidearm: still present, just not in her hand.\n\n\"Pity,\" she says. \"You would have been a good line in the report. 'Subject declined. Still convertible.'\" She walks a circle that is not quite a threat. \"Crowe isn't going to kneel in a server room. She'll wait in a place with better lighting and worse mercy. I was doing you a kindness. Kindness is the one thing you people keep refusing as if it were poison.\"",
        "\"It is poison,\" you say. \"It's just mixed with something I used to like.\" She almost respects that. Respect on her face looks like hunger that has been told to sit.\n\n\"Then run your little auction,\" she says. \"Voss on one channel, Crowe on the other, you in the cold pretending the keys are a moral philosophy. I'll be in the atrium. If you bleed, try not to ruin the marble. We just sealed it.\" She leaves through the trees. Her heels write a diminishing argument on the grate. You are alone with the packet and the two voices about to become people.",
      ],
      next: "c20_comms",
    },
    ...
    c20_crowe_ask: {
      ...
      speaker: "Crowe",
      pages: [
        "Helene Crowe does not say your name first. She says \"Darling,\" which is worse, because it fits too many mouths. Ice turns in her glass. \"Maren tells me you were disciplined. Or entertaining. Either way, you have my property in your pocket. Bring it upstairs. I will not insult you with a speech about the future of wellness. You have seen the chairs. You know what we mint. You know that someone will mint it. The only adult question is whether you sit on the board or under it.\"\n\nShe lets you hear her stand, the quiet expensive sound of a woman who has never crawled a service tunnel. \"Voss will offer you a shutdown. It is a pretty word for abandoning every incomplete subject to whatever half-body we left them in. It is also a pretty word for putting Revelations back on top of a market they do not understand. Kane will sell the ashes. You know he will. I am offering you title. Not a metaphor. The legal object. You give me the packet, I give you a life that does not have to hide in trams. I give you a room. I give you my hands, which you have already learned are not kind and are extremely competent.\"",
        "A softer note, almost intimate, the blackmail-as-tenderness she has always preferred to guns. \"I do not need you to love me. I need you to stop pretending love is the currency. Bring me the keys, {{name}}. I will own the protocol and I will own the part of you that still flinches, and I will keep both in a drawer that does not flood. That is the most honest marriage left in the Stack.\"\n\nShe does not give you a roof and a time. She gives you an elevator that will open if you approach it with her property. The ice turns again. \"If you burn it,\" she adds, almost curious, \"I will not chase the smoke. I will chase you. Smoking is a habit. You are a project.\"",
      ],
      next: "c20_decision",
    },
    ...
    c20_keep: {
      ...
      pages: [
        ...
        "Maren finds you at the service door and reads the lie on you like a price tag. She could shout. She does not. \"Oh,\" she says, almost affectionate. \"You're going to die interesting.\" She lets you pass because interesting is a kind of loyalty she understands. The rain deck hits you with grid-water that has been programmed to feel like regret. You have two countries in your clothes and no roof that will not eventually ask you to pick.\n\nYou send Voss a fragment: daemon handshake, enough to keep CHRYSALIS from fruiting at scale for a week. You send Crowe a fragment: title metadata, enough to keep her from burning the building to find you. Neither fragment is the whole prayer. The whole prayer walks with you, in a shoe, toward a night that will have to be survived before it can be judged.",
      ],
      next: "c20_out",
    },
    ...
    c20_burn: {
      ...
      pages: [
        ...
        "Both channels detonate into voices and then into silence as you drop the earpiece into the glitter and grind that too. Voss will come to the roof and find weather. Crowe will find an elevator that opens on nobody. Maren will find marble and a saint's rumor. You take the stairs three at a time because the building has noticed it has been made mortal and mortality makes buildings bite.\n\nHeat blooms on every camera. Your face is a wanted object now, not a convertible one. You hit the rain deck with your lungs full of server-cold and your hands sparkling with microscopic countries. The grid-rain washes some of it off. Not enough. Never enough. You run like a person who has just insulted the idea of keys.",
      ],
      next: "c20_out",
    },
