(function () {
  ...
  Object.assign(window.STORY, {
    c09_start: {
      ...
      speaker: "",
      journal: "First morning after Vale. The body arrived before the name did.",
      pages: [
        "Morning in the Stack is a setting, not a mercy. The civic grid lifts the rain to a drizzle that looks like industry and calls it dawn. Your slot fills with the smell of other people's rice and a ventilation throat that has never learned your name. You wake because a tram bell has decided you should, and because the body Vale wrote will not let sleep be a locked room.\n\nFor a few seconds you are only a pulse. Then the pulse finds chest, finds hip, finds the place between your legs that is either a new country or an old one under different weather, and the seconds end. You are {{name}}. You are adult. You are twenty-something and employed by two firms. You are also, in the dark, a rumor of yourself. The paper flower on the grate has not moved. It looks like a witness that has chosen silence.",
        "You do not sit up like a hero. Lila's voice is still in the muscle: don't tear what they seated; don't perform fine. You roll, slowly, and the sheet tells on you. Heat. Damp. A sensitivity that makes cotton feel like a hand with opinions. If you came on the tram last night you do not remember it, which is not the same as not having done it. The stack, the half-work, the forced drip, the minimum — whichever sentence you signed — is doing night shift in your nerves.\n\nYour phone has a message from Voss already, timestamped 05:02, which means she did not sleep or she wants you to think she did not. Rain deck three. Evening. Do not be late and do not be charming. You put the phone face down. Charm is a tool she does not trust you with today. The mirror above the sink is a cheap rectangle and it is waiting. You can meet it now or you can meet it after the body has had water. Either way the glass will not blink first.",
      ],
      next: "c09_bed",
    },
    ...
    c09_bed: {
      ...
      speaker: "",
      pages: [
        "You put a hand on yourself the way you would put a hand on a weapon you were not sure was loaded. Inventory is tradecraft. Inventory is also prayer if you are being honest, and honesty is a limited resource this week. The skin is yours in the legal sense. The electricity under it is a joint account. When you press, the press answers too quickly, a radio left between stations, static and a song.\n\nYou take the hand away before the inventory becomes a second shift. Shame arrives on time, civilian, useless. You did not ask the city for a moral. You asked it for a job and it handed you a rewrite. Outside, someone laughs in the corridor as if laughter were still a public utility. You envy them in a small, specific way that has nothing to do with joy and everything to do with unexamined flesh.",
        "Dressing will be a problem. So will not dressing. The bag from Helix sits on the chair like a guest who has overstayed and paid the rent. Inside: the cut that matches what you are now, the coat that is too nice, the card for a follow-up you will treat as a threat. Your old clothes are in the locker on Plate Six or in a bag you do not remember carrying. Either way they belong to a yesterday that still has your face in it.\n\nYou stand. The floor is cold. The gait cue, if Vale seated one, fires in the hip before pride can file a dissent. You catch the sink with both hands and look at the tap instead of the glass. Water first. Then the meeting. Then the city, which will not care what you signed so long as you look like a person who can pay for a tram. Your mouth says {{name}} to the porcelain, a roll call. The porcelain does not argue. It is the last honest surface in the slot.",
      ],
      next: "c09_gate",
    },
    ...
    c09_gate: {
      ...
      speaker: "",
      text: "The cheap rectangle waits. You can lift your eyes or you can wash your hands for twenty minutes and call it hygiene. The building you left last night does not do hygiene. It does continuity. Continuity is a prettier word for not being allowed to look away.\n\nHow do you meet the face they issued.",
      choices: [
        {
          text: "Meet the woman Vale minted. Full conversion, first morning.",
          to: "c09_trans",
          require: { flag: "transitioned" },
        },
        {
          text: "Meet the surface. Man in a woman's weather.",
          to: "c09_half",
          require: { flag: "half" },
        },
        {
          text: "Meet what they forced. Count the theft.",
          to: "c09_forced",
          require: { flag: "forced_mod" },
        },
        {
          text: "Meet the stack. The door that knows it is a door.",
          to: "c09_depraved",
    ...
    c09_trans: {
      ...
      speaker: "",
      pages: [
        "The woman in the glass is not a costume. That is the first violence of the morning. She has your eyes — the part CHRYSALIS has not learned to mint cheaply — and a mouth that looks like it has been kissed by a building. Breasts you did not grow in any ordinary year sit on you with the arrogance of fact. When you turn, they turn. When you breathe, they make a small argument with the air. Your voice, when you try it, comes out in the frequency Vale dropped into your throat, {{name}} said like a secret that got promoted.\n\nYou part the cheap underwear Helix issued and look because looking is the job and also because if you do not look someone else will describe you first. The cunt is real, swollen from sleep, a cleft that answers the pad of your finger with a heat so immediate you have to hold the sink. You do not come. You could. That is the new physics. You take the hand away shaking and laugh once, a sound the old chest could not have made.",
    ...
    c09_half: {
      ...
      speaker: "",
      pages: [
        "The man in the glass is wearing a woman's weather and the weather is not weather, it is tissue. Your face has a softness at the cheek and mouth that will pass at two meters under gala light. Your chest has a breast's idea of itself: small, sore, undeniable when a shirt pulls. You cup one because you are an idiot and a professional and the nerve is a live wire. Your cock is still there, half-hard from nothing but morning and chemistry, looking editorial against a body that has been footnoted.\n\nYou stroke once, experimental, and the old shape delivers a new electricity. Vale said the electricity would win arguments. He was not wrong. You take the hand away before you spend yourself into the sink like a person with no tradecraft. The scent lock, if that is what this sweetness is, makes the slot smell faintly like night flowers that do not grow on this plate.",
        "Passing will be a negotiation. Silk will say yes. Steam will say no. A bathroom will be a thesis defense. You practice the gait in three steps and hate how natural the third one feels. Habit is what they installed. Habit is how legends stay seated when the actor wants a union break.\n\nYou tell the glass you are still a man. The glass does not take dictation. It shows a liaison who can enter a room as a rumor and leave as a receipt. You splash water, watch it run over the new swell, and understand why Crowe prefers full and why you did not give it to her. The leftover is not dignity exactly. It is a spare key. Spare keys get lost. You put this one in the part of your head that still has a locked drawer, next to Mia's name, and you do not open either.",
      ],
      next: "c09_shower",
    },
    ...
    c09_forced: {
      ...
      pages: [
        ...
        "You touch your chest and the touch is a bruise that does not show. You touch your cock and it answers like a collaborator. The shame of that collaboration is so complete it becomes useful: you now know exactly how the building enters a person. Not with a speech. With a bag the color of dirty ice and a nurse who said sorry while she held you down.\n\nLila's face crosses the glass like a watermark. You do not forgive her. You do not have to, to use what she gave you — the word forced, logged, a sentence Voss can spend. You splash water until your hands stop shaking enough to hold a toothbrush. The toothbrush is civilian. You cling to civilian objects the way drowning people cling to furniture. The city is not water. The city is a grid. Grids do not care if you can swim. They care if you stay in the lane.",
      ],
      next: "c09_shower",
    },
    ...
    c09_min: {
      ...
      pages: [
        ...
        "You wash your face and watch water take the night off your mouth. For a moment you let yourself feel the ugly cousin of pride: you did not ask the building to invent a new animal. You asked it to stamp a file. The stamp still burned. The burn is information. You will take it to Voss or you will hide it, and either choice will be a kind of sex the firms understand.\n\nThe paper flower watches. You almost tell it you are fine. Fine is a word Lila would not let you use at the desk. You use it anyway, privately, a lie that keeps the slot from becoming a clinic. Then you turn toward the shower because the city will smell last night on you — citrus, copper, gel — and you need to smell like someone who lives here, even if living here is a cover story you are still writing with a stolen pen.",
      ],
      next: "c09_shower",
    },
    ...
    c09_sex2: {
      ...
      speaker: "",
      pages: [
        "Clothes become a negotiation you win by not explaining. If Vale gave you a cunt he finds it with fingers that have learned patience from machines, and you are so wet it startles him into a laugh he swallows against your throat. He fucks you on the cheap sheets with his coat still half on, a man who did not plan this and is trying not to be a thief. You come around him too fast, the stack or the grief or the simple fact of being entered by someone who asked, and you bite his shoulder so you do not say Lila or Vale or Voss. He holds still until you tell him to move, and then he moves, and the second climax is uglier and more yours.\n\nIf he finds a cock he does not make a speech. He takes you in his mouth with a practical hunger, ink-stained fingers on your hip, and the new electricity and the old shape argue until the argument spends itself on his tongue. You shake. He wipes his mouth with the back of his hand like a printer wiping a plate. \"Okay,\" he says, as if okay were a setting. You pull him up and stroke him until he comes on your belly, hot, ordinary, a fact that belongs to this room and not to a packet.",
    ...
    c09_end: {
      ...
      speaker: "",
      journal: "{{name}} spent a day in the rewrite. Voss is the next mirror.",
      pages: [
