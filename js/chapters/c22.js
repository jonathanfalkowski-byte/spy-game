(function () {
  ...
  Object.assign(window.STORY, {
    ...
    c22_identity_4: {
      ...
      speaker: "",
      pages: [
        "Crowe does not chase you if you walked out as yourself. She chases projects. You have made yourself a poor investment: closed file, unconvertible, a flinch that no longer photographs well. Maren sends, once, a photograph of the atrium marble with no caption. You delete it. Deleting is a skill you learned late and like. Helene Crowe will own other mouths. You wish, in a way that is not kind and is not not kind, that those mouths have last nights they chose. Then you stop wishing about her, because wishing is how she stays in the room.\n\nSubject Zero — if you met {{him}}, if that file sat in your eye — remains COMPLETE / STABLE / NON-TESTIFYING. You do not try to make {{him}} testify. Testimony is a firm hunger. You leave an orange on a certain bench one winter because the file mentioned oranges, and you never know if it was taken by the right person. That is as close as you come to being a saint. Saints, Voss said, are kindling. You prefer to be kindling that stayed in the bundle.\n\nIves dies or does not die; senators have a way of doing both at once. His FOR THE RECORD sits in a packet someone still holds, or in glitter, or in Voss's daemon. His daughter inherits a name that smells of rye and does not write to you. You are grateful. Daughters who write become chapters.",
    ...
    c22_double: {
      ...
      pages: [
        ...
        "Crowe knows. Of course she knows. She finds the other slot and leaves a brass lamp and a note: DARLING, SPLIT THINGS BRUISE. She bills you in hours and in skin. When you go upstairs she stamps your mouth and asks for fragments with her hand already on your hip, placing. You give her enough to keep the atrium marble unstained by your blood. You withhold enough to keep Voss's roofs intact. Maren writes reports that contradict each other and is promoted for the poetry. Vale, delighted, calls you a patient who doses {{himself}}. You stop seeing Vale because delight like that is a chair.",
      ],
      next: "c22_double_2",
    },
    ...
    c22_owned: {
      ...
      speaker: "",
      pages: [
        "You accept the stamp. Kane invoices Crowe before you reach the lift. The lift does not show floors. It shows a progress bar, and this time the bar is your remaining autonomy, and it completes with a chime that sounded like a wedding in a language you did not speak in the orchard. Helene Crowe is in the lamp. She does not ask if you are sure. Sure is a civilian superstition. She puts her thumb on your mouth and the paint is wet. She says, \"Darling,\" and the word finally has only one mouth to fit.\n\nThe suite is high enough that the Stack looks like inventory. Sheets better than the rented dark. A closet that already holds your size, minted or not. A schedule on a glass panel: morning walk, clinic if needed, atrium appearances, nights that are not last because they are numbered. Maren brings a report and looks at your throat the way she looked at BOSC, hungry, promoted, denied the first claim and promoted for surviving the denial. You let her look. Looking is in her job description. Touching you now requires Crowe's initials. Maren hates the initials. Hate keeps her useful.",
        "Voss's channel dies on the second day and stays dead. You stand at the suite glass and try to find the north roof and you cannot, because Helix's weather is in the way. You drink tea made right by a person who is not Voss and it tastes like a closed file. You do not cry. Crying photographs as regret and regret is a heading Crowe does not permit in her collection. You put the flinch on like jewelry when she comes home. She likes it. She pays for it with her hands, competent, unkind, extremely present. You come under her with the brass lamp on because she likes to see what she owns. You let yourself be seen. Seen is the marriage.",
    ...
    c22_owned_3: {
      ...
      pages: [
        ...
        "Maren tries, once, to take you against a rack in a new orchard, a sequel building. You say no because no now belongs to Crowe, and the belonging is a sick joke you both hear. Maren smiles with a new tax status and writes you down as STILL CONVERTIBLE / NOT MINE. You almost like her for the last two words. Vale publishes a paper on loyalty as an endocrine event. Your file is in the appendix, anonymized badly. Kane sends a fruit basket. You throw the fruit away and keep the basket for Maren's reports. Completeness loves containers.",
        "You ask Crowe, once, in the lamp, if you can leave. She considers it as policy. \"Walking is permitted,\" she says. \"Returning is required. If you walk and do not return I will not chase the smoke. I will chase you. You are a project. I have said so.\" You walk the next day to Plate Four and stand across from the hospital and do not go in. You return. She does not gloat. She takes you to bed and is almost careful, which is her version of thank you. You hate the thank you. You come anyway. The mammal does not honor grudges.",
      ],
      next: "c22_owned_4",
    },
    ...
    c22_owned_4: {
      ...
      speaker: "",
      pages: [
        "You see the drawer. She shows you because showing is a kind of stamp. Title, if she holds it, sits next to photographs of your flinch and a copy of Kane's invoice and a note in her hand: KEEP. The note is not love. It is inventory with a pulse. You touch the packet and she watches to see if you will burn it. You do not. Burning now would be a folk song in a suite, and folk songs stain marble. You close the drawer. She kisses you like a filing.\n\nSubject Zero dines with you once, a warning and an advertisement at the same table. COMPLETE / STABLE / NON-TESTIFYING, beautiful the way a closed protocol is beautiful. Zero says, \"She will keep you until keeping is less interesting than replacing. Make yourself interesting without becoming a chair.\" You do not know how. You try books. You try being funny. You try refusing the bed one night, a small unused country. Crowe stays twenty minutes as a witness, as she did in the rented dark if you refused her then, and the witnessing still works. You ask for the bed before the twenty is up. She does not say I told you so. She is too competent for that.",
    ...
    c22_dead_3: {
      ...
      pages: [
        ...
        "Lila, off shift, puts a paper flower on a grate on Plate Two. You never see it. Vale writes in a private notebook: incomplete follow-up. He does not file it. Ives's FOR THE RECORD is read in a hearing that uses your leak as color. His daughter does not write. Subject Zero leaves an orange on a bench. It rots. Rot is also continuity.\n\nYou live three months like this, then six, then a year that should have been impossible. Impossibility is a kind of cover. Heat cools when the song gets old. Songs get old. New saints are minted. You are a verse people skip.",
      ],
      next: "c22_dead_4",
    },
