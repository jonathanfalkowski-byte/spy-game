...
| opening.apartment.inspect-mirror | apartment.* optional INSPECT_APARTMENT mirror | Bathroom-mirror inspection | MISSING_UNIQUE | None | Approved Adrian identity still required; canonical apartment geography | Yes | P0 |
