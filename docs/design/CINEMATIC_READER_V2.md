...
**Superseded after human review:** the three-column geometry below was rejected. The current implementation is documented in [Final EVE reader shell](FINAL_EVE_READER_SHELL.md), with art above scrolling story and assessment attention/records. This document remains a historical experiment receipt.
