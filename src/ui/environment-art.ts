...
const masters = {
  ...
  wardrobe: { assetId: 'eve-bg-wardrobe-continuity-noir-v2-production', alt: 'A dressing area: a suit, a gown and a dress on the rail beside a lit vanity mirror.' },
  car: { assetId: 'car-rain-window-noir-v2-production', alt: 'Rain beads across the car window as the city passes in the blue light.' },
  ...
  executiveOffice: { assetId: 'eve-bg-sloane-office-continuity-noir-v2-production', alt: 'An empty executive office high above the city, the desk facing the windows.' },
  glassLobby: { assetId: 'eve-bg-glass-lobby-noir-v2-production', alt: 'The Glass House elevator lobby at night: dark marble, one warm sconce and closed elevator doors.' },
