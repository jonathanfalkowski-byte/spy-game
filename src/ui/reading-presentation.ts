...
export function thoughtLabel(node?: string): string {
  ...
  const living =
    ['mission', 'chapter3', 'chapter4', 'chapter5', 'chapter6', 'chapter7', 'chapter8', 'chapter9', 'chapter10', 'chapter11', 'chapter12', 'chapter13', 'chapter14'].includes(scene) ||
