...
export const clinicScenes = SceneSchema.array().parse([
  ...
  scene('voice', 'A voice arriving', '08:03 · First adaptation checkpoint', [
    ...
    p(
      'You stop after the question. The last word hangs in the quiet room, higher and softer than you expected. You swallow and feel the movement in your throat. Nothing about making the sound felt unfamiliar until you heard it.',
    ),
    q(
      'Voss',
      'Twenty-seven minutes. Your voice changed while you were asleep. Does your throat hurt? Take your time; I need to hear a little more before we adjust it.',
    ),
    t(
      'For a second I thought someone else had spoken. I want to try again. I also want everyone to stop listening.',
    ),
    q(
      'Voss',
  ...
  scene('voicePause', 'The sequence is suspended', '08:07 · Procedure paused', [
    ...
    p(
      'In the silence you can hear air moving through a vent above the door. Voss takes two fingers from your wrist but stays beside the chair. Sloane lowers the hand she had raised to interrupt.',
    ),
    q(
      'Voss',
  ...
  scene('face', 'A face in progress', '08:41 · Second adaptation checkpoint', [
    p(
      'Voss asks where you are, whether anything hurts, whether you can hear her. Sometimes you answer before she finishes. Once she smiles at your impatience. Then she brings the mirror around on its arm and rests a hand on its covered edge. “Ready to look?” You can turn away if you need to.',
    ),
    p(
      'The mirror clears. You notice the mouth first, then the softer line where your jaw used to catch the light. You tighten your lips. The woman does it with you. A crease appears between her brows—your habitual look of concentration, on a face you have only seen on a screen.',
    ),
    t(
      'That frown. I know that frown. I almost laugh, which seems so wrong that I hold my breath instead.',
    ),
    p(
  ...
  scene('steps', 'Stand', '09:26 · Stage One complete', [
    p(
      'Voss loosens the supports one at a time. Cool air touches the places they covered. You rub a faint mark on your wrist while the chair rises beneath you, then lower your feet until your soles find the floor. The garment pulls across your lap in a way you keep trying to correct.',
    ),
    q(
      'Voss',
      'Stay seated a moment. Both feet on the floor. Good. Tell me when you are ready; I am right here.',
    ),
    p(
      'You lean forward as you have done a thousand times and catch yourself with a hand on the chair. Not a fall; barely even a stumble. It is enough to make your face grow hot. Voss waits without remarking on it. Behind her, Sloane moves away from the recovery door.',
    ),
    t(
      'I would rather Sloane had not seen that. Ridiculous thing to care about after this morning. I care anyway.',
    ),
  ]),
  scene('mirror', 'Evelyn looks back', '09:29 · Recovery suite', [
    p(
      'The recovery room is warmer. A robe lies folded over a chair, and condensation has gathered beneath the glass of water beside it. Across the room, a floor-length mirror catches the pale doorway. Voss points out the handrail and lets you choose where to go.',
    ),
    p(
      'A seam in the wall divides the mirror from a panel of dark wood. You keep your eyes on that seam for a moment. Nobody moves to uncover anything or turn a screen toward you. The room is quiet enough to hear the water settle when Voss sets down the glass.',
    ),
    t('I could look now. I could sit down first.'),
  ]),
  scene('name', 'A name used as an instruction', '09:34 · Recovery suite', [
    q('Voss', 'Adrian?'),
    q('Adrian', 'I heard you.'),
    p(
      'Your answer sounds clearer than it did beside the chair. Voss nudges the water closer. At the door, Sloane has one hand resting on the frame. Her gaze stays on you a moment longer than a glance should.',
    ),
    q('Sloane', 'Evelyn.'),
    p(
      'You had been reaching for the glass. Your hand stops just above it. Sloane waits for you to turn toward her.',
    ),
  ]),
  ...
  scene('wardrobe', 'What you wear into the room', '15:20 · Preparation suite', [
    p(
  ...
  scene('presentationReview', 'One last look before you leave', '16:00 · Fitting review', []),
...
for (const [id, label] of [
  ...
  add('steps', 'step.' + id, 'mirror', label, 'Take your time. Voss stays nearby.');
for (const [id, label] of [
  ['me', 'That is me.'],
...
export function clinicBlocks(s: GameState): Block[] {
  ...
  if (phase === 'morningReply') {
    if (c.morning === 'answer')
      ...
      blocks.push(
        ...
        p(
          'The screen goes dark. You do not know what Maya will do with the unanswered call. For now, there is only the appointment and the phone you put back in your jacket.',
        ),
      );
      ...
      blocks.push(
        ...
        t(
          c.exam === 'equipment'
            ...
            : c.exam === 'scan'
              ? 'My annual screenings are inside this model. How long has a routine appointment meant something else?'
    ...
    blocks.push(
      ...
      p(
        c.profileDraft === 'existing'
          ? 'The original looks exactly like the photograph Sloane presented. You remember the angle at which she held the screen and how long it took you to look away.'
          : c.profileDraft === 'executive'
            ? 'The change is small enough that you have to alternate the two images to see it clearly. There is more severity around the mouth. You find yourself straightening in the chair, then deliberately leaning back.'
            : c.profileDraft === 'socialite'
              ? 'The expression looks warmer, more readily noticed across a room. You can imagine someone approaching her to speak. Imagining yourself having to answer takes longer.'
              : 'The quieter version holds your attention precisely because it seems less arranged to hold anyone else’s. You ask Voss to put the original beside it once more.',
      ),
      p(
  ...
  if (phase === 'display')
    blocks.push(
      p(
        c.attention === 'sloane'
          ? 'Sloane is looking at you rather than the display. When you meet her eyes, she does not turn away. Her fingers rest motionless against the edge of the table.'
          : c.attention === 'away'
            ? 'You turn toward the window. The imitation daylight has not changed since you arrived. For a few breaths you watch it, then look back at the table. Sloane has not moved.'
            : c.attention === 'technical'
              ? 'You follow the tolerance ranges until Voss explains where the model is least certain. You ask her to explain one of the ranges again. This time you manage to listen to the whole answer.'
              : c.attention === 'body'
                ...
                : 'The uneven corner of the mouth catches your attention again. You almost touch your own mouth to compare them, then notice Sloane and leave your hand where it is.',
      ),
      q('Sloane', 'Well?'),
      t('She has let the silence go on just long enough that I want to fill it.'),
    );
  ...
  if (phase === 'voiceReply')
    blocks.push(
      p(
        c.voice === 'lower'
          ? 'Voss lowers the register a little and asks you to repeat the sentence. This time you feel a faint vibration lower in your throat. The sound is still changed, but you can finish speaking without stopping to listen to the first word.'
          : 'Voss applies the established Evelyn register. There is a warmth at the end of the next sentence that surprises you. You repeat it more flatly, testing whether you can lose the inflection. You can. Voss waits while you try once more.',
      ),
      q('Adrian', 'I would like a glass of water when you can give me one.'),
      p(
        'Voss reaches toward the water, then checks the monitor before bringing it within reach. You watch the glass instead of her face. You are thirsty enough to resent the delay and embarrassed by how much you want her to hear you sounding ordinary.',
      ),
      q('Voss', 'We can leave it there. Do not force it. Tell me if speaking begins to hurt.'),
    );
  if (phase === 'faceReply')
    blocks.push(
      ...({
        unfamiliar: [
          ...
          q(
            'Voss',
            'Would you like me to turn the mirror away for a moment? We can take this slowly.',
          ),
        ],
        temporary: [
        ...
        beautiful: [
          ...
          q('Voss', 'Take your time, Adrian.'),
        ],
        sloane: [
          q('Adrian', 'Is this what you expected?'),
          q('Sloane', 'You are adapting faster.'),
          p(
            'Voss looks sharply at Sloane. A moment passes before she returns to the monitor. You glance from one woman to the other, waiting for someone to finish the conversation.',
          ),
        ],
      }[c.face || 'unfamiliar'] || []),
      p(
  ...
  if (phase === 'name')
    blocks.unshift(
      t(
        (
          {
            me: 'I lift my hand. Of course she lifts hers. It is the expression when I lower it that catches me. I know that look.',
            notme:
              'No. I say it in my head, then again, as though she might have misunderstood. My hand has found the edge of the robe and will not let go.',
            unknown:
              'I keep waiting for one feeling to settle. Every time I think it has, something else interrupts.',
            beautiful:
              'She is beautiful. I look away, annoyed with myself, then look back. I had not meant to do that.',
            anger:
              'They had the photograph ready yesterday. I am standing here trying to get through a single minute, and they had time to choose the lighting.',
            unnamed: 'There is a word somewhere. I reach for it and lose it. I want the water.',
            skip: 'I keep my eyes on the chair and the folded robe. Sitting down takes all the attention I have.',
  ...
  if (phase === 'makeup')
    blocks.unshift(
      p(
        c.outfitDraft === 'executive'
          ? 'The jacket has more weight than it seemed to have on the hanger. You pull each cuff into place, then run a thumb along the inside of a lapel. The gesture is familiar enough to bring back a meeting room upstairs: your old suit, a presentation you had stayed late to finish, Benton checking the time.'
          : c.outfitDraft === 'socialite'
            ? 'The dress moves against your legs when you cross the dressing room. You stop, turn, and feel the fabric follow a fraction later. Sitting takes an extra moment while you work out where to put your hands. You stand again before anyone has had time to knock.'
            : 'Up close, the quiet outfit has details you missed on the rail: a narrow seam, a fastening hidden under a fold. You smooth it once and step back. Nothing catches the light until you move. You try walking past the mirror instead of standing squarely in front of it.',
      ),
    );
  if (phase === 'presentationReview')
    blocks.push(
      ...
      p(
        'You walk to the door and come back. The clothes move with you instead of hanging as they did on the rail. You stop beside the chair, wondering whether to adjust something else. Beyond the closed door, someone laughs briefly, then a trolley rolls past.',
      ),
      p('There is still time to change. When you are ready, Sloane is waiting in the next room.'),
    );
  if (phase === 'rehearsal')
    blocks.push(
      ...rehearsal(s),
