...
export function leverageBoard(s: GameState): { held: LeverageEntry[]; holds: LeverageAsset[] } {
  ...
  if (c(s, 'end.switch'))
    holds.push({
      id: 'switch-final',
      label: c(s, 'end.switch') === 'armed' ? 'The switch, armed, for the rest of your life' : c(s, 'end.switch') === 'handed' ? 'The switch, held for you by someone you trust' : 'Nothing aimed at anyone. The letters burned.',
      source: 'Your own kitchen table',
    });
