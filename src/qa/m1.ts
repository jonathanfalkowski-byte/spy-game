...
const sourceFor = (type: Intent['type']) => {
  ...
  if (type === 'CHAPTER10_CHOOSE') return 'chapter10';
  if (type === 'CHAPTER11_CHOOSE') return 'chapter11';
  if (type === 'CHAPTER12_CHOOSE') return 'chapter12';
  if (type === 'CHAPTER13_CHOOSE') return 'chapter13';
  if (type === 'CHAPTER14_CHOOSE') return 'chapter14';
  if (type === 'CHAPTER15_CHOOSE') return 'chapter15';
  if (type === 'CHAPTER16_CHOOSE') return 'chapter16';
  if (type === 'CHAPTER17_CHOOSE') return 'chapter17';
  if (type === 'CHAPTER18_CHOOSE') return 'chapter18';
