...
export function applyClinicChoice(state: GameState, s: GameState, id: string): boolean {
  ...
  if (id.startsWith('step.'))
    response.push(
      p(
        value === 'help'
          ? 'Voss’s hand is warm and dry. You grip it harder than you intend. She does not pull; she waits until your weight is over your feet. After the first few steps you loosen your hold, then let go. She walks beside you through the recovery door.'
          : value === 'moment'
            ? 'You ask for a moment. Voss settles against the edge of the desk and waits. You press your soles against the floor until the pressure feels even, then tell her you are ready. The walk to recovery is slow enough that you can hear the brush of her coat beside you.'
            : 'You brace a hand against the chair and stand. Voss moves with you, close enough to catch your elbow. For a moment you are irritated by that; a moment later you are glad. You follow her into recovery, taking shorter steps than you expected.',
      ),
    );
  ...
  if (id.startsWith('name.')) {
    ...
    response.push(
      ...
      p(
        value === 'correct'
          ? 'Sloane inclines her head. You cannot tell whether she is accepting the correction or simply waiting until you are less tired.'
          : 'Sloane lets the silence return. You take the water before she can ask another question.',
      ),
    );
