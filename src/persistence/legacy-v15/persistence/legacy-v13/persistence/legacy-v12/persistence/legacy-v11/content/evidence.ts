  ...
  .parse([
    {
      ...
      thought:
        'Voss moved from the company Helix is buying into Axiom. Now her record points to a restricted project. I can see the connection, but not what it means.',
    ...
    },
    {
      ...
      thought:
        'The restriction still stands. That is something I can verify. It does not tell me why Helix wants Novagen.',
