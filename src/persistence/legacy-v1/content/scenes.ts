...
export const scenes = SceneSchema.array().parse([
  ...
  },
  {
    ...
    blocks: [
      p(
        'You leave the apartment, taking your jacket and phone. The journey carries you through the wet morning toward the tower you could see from home.',
      ),
      p(
        'Inside Axiom, you pass through the lobby and take the elevator to Strategic Intelligence. By the time you reach your desk, the day has begun without you.',
      ),
    ],
    next: 'office.daniel',
  ...
  },
  {
    ...
    blocks: [
      ...
      t(
        'Daniel has worked two desks over from me for four years. Clever, indiscreet, kinder than he wants anyone to notice. I am grateful he came himself—and angry that Benton left it to him.',
      ),
      s(
        'Daniel Kessler',
  ...
  },
  {
    ...
    blocks: [
      p(
        'Helix Corporation is acquiring Novagen Bio. The official rationale is simple: Helix wants its adaptive-cell patents. The deal sponsor is Marcus Chen, Helix Director of Strategic Acquisitions. Benton wants a narrow risk note before lunch.',
      ),
      t(
  ...
  },
  {
    ...
    blocks: [
      p(
        'Review the exact report below. Submitting sends it to Benton and closes this investigation. Any unused opportunity ends with the deadline. You can revise before committing.',
      ),
    ],
  },
  {
  ...
  },
  {
    ...
    blocks: [
      p(
        'Maya returns toward the compliance wing. You turn back to your desk. The coffee is still warm, and the Helix report has already left your hands.',
      ),
      p(
        'This opening ends here. Your decisions and the information you chose to share remain on the record. You can review the journal and conversation history, or start a new run.',
      ),
    ],
  },
]);
