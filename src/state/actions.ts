...
export const ActionSchema = z.discriminatedUnion('type', [
  z.object({ ...revision, type: z.literal('CONTINUE_AUDIT_REVISION') }).strict(),
  ...
  z.object({ ...revision, type: z.literal('CHAPTER9_CHOOSE'), id: z.string().max(80) }).strict(),
  z.object({ ...revision, type: z.literal('CHAPTER10_CHOOSE'), id: z.string().max(80) }).strict(),
  z.object({ ...revision, type: z.literal('CHAPTER11_CHOOSE'), id: z.string().max(80) }).strict(),
  z.object({ ...revision, type: z.literal('CHAPTER12_CHOOSE'), id: z.string().max(80) }).strict(),
  z.object({ ...revision, type: z.literal('CHAPTER13_CHOOSE'), id: z.string().max(80) }).strict(),
  z.object({ ...revision, type: z.literal('CHAPTER14_CHOOSE'), id: z.string().max(80) }).strict(),
  z.object({ ...revision, type: z.literal('CHAPTER15_CHOOSE'), id: z.string().max(80) }).strict(),
  z.object({ ...revision, type: z.literal('CHAPTER16_CHOOSE'), id: z.string().max(80) }).strict(),
  z.object({ ...revision, type: z.literal('CHAPTER17_CHOOSE'), id: z.string().max(80) }).strict(),
  z.object({ ...revision, type: z.literal('CHAPTER18_CHOOSE'), id: z.string().max(80) }).strict(),
