...
it.skipIf(!dir)('dumps golden-route transcripts', () => {
  ...
  const routes = [
    ...
    ...[golden6, golden7, golden8, golden9, golden10, golden11, golden12, golden13, golden14, golden15, golden16, golden17].flatMap((g, i) => g.routes.map((r) => [`ch${i + 6}-${r.name}`, r.ledger] as const)),
  ];
