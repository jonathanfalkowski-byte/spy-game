...
function fillDefault(s: GameState): GameState | undefined {
  const fill = [...chapter7Choices(s), ...chapter8Choices(s), ...chapter9Choices(s), ...chapter10Choices(s), ...chapter11Choices(s), ...chapter12Choices(s), ...chapter13Choices(s), ...chapter14Choices(s)].find((c) => GATED_DEFAULTS.includes(c.id));
  if (!fill) return undefined;
  const type = ({ chapter7: 'CHAPTER7_CHOOSE', chapter8: 'CHAPTER8_CHOOSE', chapter9: 'CHAPTER9_CHOOSE', chapter10: 'CHAPTER10_CHOOSE', chapter11: 'CHAPTER11_CHOOSE', chapter12: 'CHAPTER12_CHOOSE', chapter13: 'CHAPTER13_CHOOSE', chapter14: 'CHAPTER14_CHOOSE' } as const)[fill.id.split('.')[0] as 'chapter7'];
