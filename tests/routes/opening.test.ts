...
import { chapter12Scenes } from '../../src/content/chapter12';
...
import { chapter17Scenes } from '../../src/content/chapter17';
import { chapter18Scenes } from '../../src/content/chapter18';
...
it('validates legacy nodes reach their existing endpoints; revisions 14 through 16 are covered by playable route tests', () => {
  ...
  expect(reachable.size).toBe(scenes.length-Object.keys(nextSceneDefinitions).length-chapter4Scenes.length-chapter5Scenes.length-chapter6Scenes.length-chapter7Scenes.length-chapter8Scenes.length-chapter9Scenes.length-chapter10Scenes.length-chapter11Scenes.length-chapter12Scenes.length-chapter13Scenes.length-chapter14Scenes.length-chapter15Scenes.length-chapter16Scenes.length-chapter17Scenes.length-chapter18Scenes.length);
});
